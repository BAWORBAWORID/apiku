...
/**
 * Alight Motion Premium — direct Google Identity Toolkit service
 * No third-party API. Based on am.js (converted to ESM service).
 */
...
const amService = new AlightMotionService();
